...
const handleSubmit = async (e) => {
  ...
  <dialog className="modal modal-open">
    <div className="modal-box">
      <h3 className="font-bold text-lg">You have logged in successfully!</h3>
      
      <div className="modal-action">
        <button className="btn btn-primary" onClick={() =>{ setShowModal(false); navigate('/chat') }}>Close</button>
      </div>
    </div>
  </dialog>
)}
